...
Task C:
'''
print("This says that the first place team is better than the second place team with 99.5% confidence.", ttest(Y, allP[1], allP[0]))
print("This says that the second place team is not significantly better than the third place team, even at 90%.", ttest(Y, allP[2], allP[1]))